...
<script type="text/javascript">
	...
	function showRemarkList(){
		$.ajax({
			...
			dataType:"json",
			success:function (data){
				//data:[{clueRemark1},{2},{3}...]
				var html = "";
				$.each(data,function (i,n){
					html+=' <div class="remarkDiv" id="showRemark" style="height: 60px;">';
					html+=' <img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
					html+=' <div style="position: relative; top: -40px; left: 40px;" >';
					html+=' <h5>'+n.noteContent+'</h5>';
					html+='<font color="gray">线索</font> <font color="gray">-</font> <b>${c.fullname}</b> <small style="color: gray;"> '+n.createTime+' 由'+n.createBy+'</small>';
					html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html+='<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #eea236;"></span></a>';
					html+='&nbsp;&nbsp;&nbsp;&nbsp;';
					html+='<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #eea236;"></span></a>';
					html+='</div>';
					html+='</div>';
					html+='</div>';
				})
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				...
				<p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
					<button id="cancelBtn" type="button" class="btn btn-default" id="unSaveRemarkBtn">取消</button>
